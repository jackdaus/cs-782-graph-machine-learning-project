...
Train a Siamese GAT model to predict translation between two graphs.

Usage:
    python e1_learn_translation.py
    python e1_learn_translation.py model.embedding_size=32 training.num_epochs=500
"""
