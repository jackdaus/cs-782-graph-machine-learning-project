...
Good [basic example](https://github.com/colmap/colmap/blob/f8edccaa36909713b9d3930e1ca65cb364a38b26/python/examples/example.py) from the colmap authors.
...
```bash
uv run .\02_basic_pipeline_with_rerun.py
```